...
typedef Clay_ClipElementConfig Clay_ScrollElementConfig;
...
static Clay_ElementDeclaration ParseComponentOptions(ComponentOptions options, Clay_ElementDeclaration defaultOptions) {
  ...
  // Scroll parse
  {
    ...
    if (firstChar == 'v') {
      result.clip = (Clay_ScrollElementConfig){.vertical = true};
    }

    if (firstChar == 'h') {
      result.clip = (Clay_ScrollElementConfig){.horizontal = true};
    }

    if (firstChar == 'b') {
      result.clip = (Clay_ScrollElementConfig){.vertical = true, .horizontal = true};
    }
  }
